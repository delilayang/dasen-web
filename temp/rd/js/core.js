        ...
        if (typeof($LAB) != 'object') {
            ...
            initNoticeData(function(notice) {
                if (notice.length) {
                    ...
                    var html = '<marquee behavior="scroll" scrollamount="5" scrolldelay="100" loop="-1" onmouseover="this.stop();" onmouseout="this.start();" >';
                    ...
                    $("#noticeDom").append('<marquee behavior="scroll" scrollamount="5" scrolldelay="100" loop="-1" onmouseover="this.stop();" onmouseout="this.start();" >欢迎来到荣鼎</marquee>');
                }
            });
        }
    };
