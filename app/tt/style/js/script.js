        ...
        if (typeof($LAB) != 'object') {
            ...
            initNoticeData(function(notice) {
                if (notice.length) {
                    ...
                    var html = '<marquee direction="up" scrollamount="2" scrolldelay="30" onmouseover="this.stop();" onmouseout="this.start();" >';
                    ...
                    $("#noticeDom").html('<marquee direction="up" scrollamount="2" scrolldelay="30" onmouseover="this.stop();" onmouseout="this.start();" >欢迎来到天天彩票</marquee>');
                }
            });
        }
    };
