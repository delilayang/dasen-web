        ...
        if (typeof($LAB) != 'object') {
            ...
            initNoticeData(function(notice) {
                if (notice.length) {
                    ...
                    var html = '<marquee direction="left" scrollamount="3" scrolldelay="100" width="810" onmouseover="this.stop();" onmouseout="this.start();" >';
                    ...
                    $("#noticeDom").append('<marquee direction="left" scrollamount="3" scrolldelay="100" width="810" onmouseover="this.stop();" onmouseout="this.start();" >欢迎来到易购彩</marquee>');
                }
            });
        }
    };
