...
$(".main-info-ad").slide({ interTime: 5000, effect: "left", mainCell: ".bd ul", autoPlay: true });
...
$(".promobanner").click(function() {
    var a = $(this).parent().find(".contentbody");
    "block" == $(a).css("display") ? $(a).fadeOut(500) : $(a).fadeIn(500);
});

$(".contentbody").each(function(a, b) {
    0 == a ? $(this).css("display", "block") : $(this).css("display", "none");
});
...
$(".itms").click(function() {
    ...
    $(this).find(".sprite").addClass("icon" + a);
});
...
function converTime(a) {
    var b = a % 60;
    ret = "";
    ret += "" + ~~(a / 60) + "&lsquo;" + (10 > b ? "0" : "");
    return ret += "" + b;
}

function countUp2() {
    var a = stat2 * animationspd / animationtime * timer2,
        a = Math.floor(a),
        a = converTime(a);
    $("#count2").html(a);
...
var stat1_ani, stat2_ani, stat3_ani, bodyheight = $("body").height(),
...
$(window).scroll(function(a) {
    socialpanel();
    a = $(window).scrollTop() + scrollY;
    1450 < a && 1 == runonce1 && (stat1_ani = setInterval(function() {
        countUp1();
    }, animationspd), progressbar1(), runonce1 = !1);
    1550 < a && 1 == runonce2 && (stat2_ani = setInterval(function() {
        countUp2();
    }, animationspd), progressbar2(), runonce2 = !1);
    1650 < a && 1 == runonce3 && (stat3_ani = setInterval(function() {
        countUp3();
